...
/// \brief cascades di-hadron correlation
...
struct CascDiHadronCorr {
  ...
  O2_DEFINE_CONFIGURABLE(cfgCentTableUnavailable, bool, true, "if a dataset does not provide centrality information")
  ...
  void processSame(FilteredCollisions::iterator const& collision, FilteredTracks const& tracks, aod::CascDatas const& cascades, aod::BCsWithTimestamps const&)
  {
    if (!collision.sel8())
      return;
